          ...
          <div className="sticky top-0 z-10 flex bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80" style={{ height: headerHeight }}>
            ...
            {timezones.map((tz, index) => (
              <div
                key={tz.id}
                className={cn(
                  "min-w-[90px] flex-1 py-3 pl-2 pr-6 text-center flex flex-col items-center justify-center",
                ...
                {timezones.map((tz, index) => {
                  ...
                  return (
                    <div
                      key={tz.id}
                      className={cn(
                        "min-w-[90px] flex-1 px-2 text-sm flex items-center justify-center cursor-pointer transition-colors",
                        inRange
